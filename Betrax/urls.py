...
from .views import (
    ...
    DuplicateDefectView, CannotReproduceDefectView
)
...
urlpatterns = [
    ...
    path("defects/<int:pk>/duplicate/", DuplicateDefectView.as_view()),
    path("defects/<int:pk>/cannot-reproduce/", CannotReproduceDefectView.as_view()),
]